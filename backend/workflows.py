...
WORKFLOWS = {
    ...
    "minimax_h3_t2v": {
        ...
        "fill": {
            ...
            "clip_file": [("2", "clip_name")],
            "vae_file": [("3", "vae_name")],
            "audio_vae_file": [("4", "vae_name")],
        },
    },
    "minimax_h3_i2v": {
        "model_id": "minimax_h3",
        "mode": "i2i",
        "file": "minimax_h3_i2v.json",
        "output_node": "16",
        "fill": {
            "prompt": [("6", "prompt")],
            "width": [("6", "width")],
    ...
    "ltx_2_5_i2v": {
        ...
        "fill": {
            ...
            "seed": [("14", "noise_seed")],
            "steps": [("12", "steps")],
            "sampler": [("13", "sampler_name")],
            "fps": [("10", "frame_rate"), ("20", "fps")],
            "unet_file": [("1", "unet_name")],
            "clip_file": [("2", "clip_name")],
            "vae_file": [("3", "vae_name")],
            "audio_vae_file": [("4", "vae_name")],
